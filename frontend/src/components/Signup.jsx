...
function Signup() {
  ...
  const handleChange = (e) => {
    //basically r.target value hume batati hein user kya likh raha hein
  ...
  const handleSignup = async () => {
    ...
    try {
      const { data } = await axios.post(
        ...
        {
          //to handle the cookies very easily
    ...
    <div className="min-h-screen flex items-center justify-center bg-black px-4">
      <div className="bg-[#1e1e1e] text-white w-full max-w-md rounded-2xl p-6 shadow-lg">
        ...
        <p className="text-xs text-gray-400 mt-4 mb-6">
          By signing up or logging in, you consent to InfoSeek's{" "}
